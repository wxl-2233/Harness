...
这种方式适用于简单任务，但在软件开发、系统设计、数据分析等复杂场景下，往往存在职责混乱、上下文过长、任务拆解困难等问题。为了解决上述问题，本项目基于 Claude Code 的 Harness 思想，构建了一个面向教育数据挖掘平台（Educational Data Mining Platform）的多智能体协作框架。
